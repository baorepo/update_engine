...
const char kLsbReleaseAppIdKey[] = "SLINUX_RELEASE_APPID";
const char kLsbReleaseAutoUpdateServerKey[] = "SLINUX_AUSERVER";
const char kLsbReleaseBoardAppIdKey[] = "SLINUX_BOARD_APPID";
const char kLsbReleaseBoardKey[] = "SLINUX_RELEASE_BOARD";
const char kLsbReleaseCanaryAppIdKey[] = "SLINUX_CANARY_APPID";
const char kLsbReleaseIsPowerwashAllowedKey[] = "SLINUX_IS_POWERWASH_ALLOWED";
const char kLsbReleaseUpdateChannelKey[] = "SLINUX_RELEASE_TRACK";
const char kLsbReleaseVersionKey[] = "SLINUX_RELEASE_VERSION";
