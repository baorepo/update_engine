...
class ConnectionManagerSlinux : public ConnectionManagerInterface {
 public:
  ConnectionManagerSlinux() = default;
  ~ConnectionManagerSlinux() override = default;
  ...
  DISALLOW_COPY_AND_ASSIGN(ConnectionManagerSlinux);
};
